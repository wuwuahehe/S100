...
#define LEDSEG_ALL_DIRIN() {GPIOADE |=0x78; GPIOADIR |= 0x78; GPIOFDE |=0x3; GPIOFDIR |= 0x3; GPIOEDE |=0x80; GPIOEDIR |= 0x80;}
#define LEDSEG_HDRV_EN()   {GPIOADE |=0x78;  GPIOADRV |= 0x78;GPIOFDE |=0x3; GPIOFDIR |= 0x3; GPIOEDE |=0x80; GPIOEDIR |= 0x80;}
#define LEDSEG_HDRV_DIS()  {GPIOADRV &= ~0x78;GPIOFDRV &= ~0x3;GPIOEDRV &= ~0x80;}
...
#define LEDSEG0_H()  {GPIOFSET = BIT(0); GPIOFDIR &= ~BIT(0);}
#define LEDSEG0_L()  {GPIOFCLR = BIT(0); GPIOFDIR &= ~BIT(0);}

#define LEDSEG1_H()  {GPIOFSET = BIT(1); GPIOFDIR &= ~BIT(1);}
#define LEDSEG1_L()  {GPIOFCLR = BIT(1); GPIOFDIR &= ~BIT(1);}

#define LEDSEG2_H()  {GPIOESET = BIT(7); GPIOEDIR &= ~BIT(7);}
#define LEDSEG2_L()  {GPIOECLR = BIT(7); GPIOEDIR &= ~BIT(7);}
