...
#define RES_BUF_TWS_DISCON_MP3          RES_BUF_ZN_TWS_DISCON_MP3
#define RES_LEN_TWS_DISCON_MP3          RES_LEN_ZN_TWS_DISCON_MP3
...
#define RES_BUF_TWS_CONNECTED_MP3       RES_BUF_EN_CONNECTED_MP3
#define RES_LEN_TWS_CONNECTED_MP3       RES_LEN_EN_CONNECTED_MP3
