...
#define vusb_gpio_cfg()                 {PWRCON0|=BIT(30); PWRCON1|=BIT(0);}    //VUSB GPIO EN
#define vusb_dir_output()               PWRCON0|=BIT(27)
#define vusb_dir_input()                PWRCON0&=~BIT(27)
#define vusb_output_high()              PWRCON1|=BIT(1)
#define vusb_output_low()               PWRCON1&=~BIT(1)    //输入检测内部没有上下拉
#define vusb_input_read()               (PWRCON1 >> 31)
