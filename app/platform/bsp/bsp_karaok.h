...
void pitch_shift2_init(s32 SampleRate, s32 shift);   //sampleRate: 变调音源的采样率  //shift变调范围(-32768 ~ 32767),值越小,声音频率越尖
void lock_code_pitch(void);
void unlock_code_pitch(void);
#endif
