...
#if PWR_RC_32K_EN
AT(.text.bsp.param.rtc)
void param_rtccnt_write(u8 *param)
{
    param_write((u8 *)param, PARAM_RTC_CNT, 4);
    param_sync();
}
...
{
    param_read(param, PARAM_RTC_CNT, 4);
}

AT(.text.bsp.param.rtc)
void param_rtc32clk_write(u8 *param)
{
    param_write((u8 *)param, PARAM_RTC_32CLK, 4);
    param_sync();
}
...
{
    param_read(param, PARAM_RTC_32CLK, 4);
}

AT(.text.bsp.param.rtc)
void param_rtcalarm_write(u8 *param)
{
    param_write((u8 *)param, PARAM_RTC_ALARM, 4);
    param_sync();
}
...
{
    param_read(param, PARAM_RTC_ALARM, 4);
}

AT(.text.bsp.param.rtc)
void param_rtcalarmsta_write(u8 *param)
{
    param_write((u8 *)param, PARAM_RTC_ALARMSTA, 1);
    param_sync();
}
...
{
    param_read(param, PARAM_RTC_ALARMSTA, 1);
}

AT(.text.bsp.param.rtc)
void param_rtcnsec_write(u8 *param)
{
    param_write((u8 *)param, PARAM_RTC_NSEC, 4);
    param_sync();
}
...
{
    param_read(param, PARAM_RTC_NSEC, 4);
}

AT(.text.bsp.param.rtc)
void param_rtc_pwroffhz_write(u8 *param)
{
    param_write((u8 *)param, PARAM_RTC_RCHZ, 4);
    param_sync();
}
...
{
    param_read(param, PARAM_RTC_RCHZ, 4);
}
#endif //if PWR_RC_32K_EN

AT(.text.bsp.param.spiflash)
void param_spiflash_loop0_write(u8 *param)
{
    param_write(param, PARAM_SPIFLASH_LOOP0, 4);
    param_sync();
}
...
{
    param_read(param, PARAM_SPIFLASH_LOOP0, 4);
}

AT(.text.bsp.param.spiflash)
void param_spiflash_loop1_write(u8 *param)
{
    param_write(param, PARAM_SPIFLASH_LOOP1, 4);
    param_sync();
}
...
{
    param_read(param, PARAM_SPIFLASH_LOOP1, 4);
}
