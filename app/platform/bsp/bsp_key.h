...
#define EVT_UDE_SET_VOL         0x7e2
#define EVT_HDMI_INSERT         0x7e1
#define EVT_HDMI_REMOVE         0x7e0
#define EVT_BT_POPUP_BAT        0x7de
#define EVT_DP_GND_INSERT       0x7dd
#define EVT_DP_GND_REMOVE       0x7dc
#define EVT_DPDM_SC_INSERT      0x7db
#define EVT_DPDM_SC_REMOVE      0x7da
#define EVT_UART_UPDATE         0x7d9
...
#define K_DUT_MODE              (KEY_BT_DUT | KEY_SHORT)
#define KU_DUT_MODE             (KEY_BT_DUT | KEY_SHORT_UP)
#define KL_DUT_MODE             (KEY_BT_DUT | KEY_LONG)
#define KLU_DUT_MODE            (KEY_BT_DUT | KEY_LONG_UP)
#define KH_DUT_MODE             (KEY_BT_DUT | KEY_HOLD)
#define KD_DUT_MODE             (KEY_BT_DUT | KEY_DOUBLE)
...
void ADCCH_VUSB_EN(void);           //使用VUSB做ADC检测脚时，在每个模式的func_**_enter之后调用此函数
