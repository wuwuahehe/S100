...
#include "sfr.h"
    ...
    #define SD_DAT_DIS_UP()         static unsigned long pu300, pu,dir; pu300 = GPIOBPU300; pu = GPIOBPU; dir = GPIOBDIR; GPIOBDIR |= BIT(4); GPIOBPU300 &= ~BIT(4); GPIOBPU &= ~BIT(4); GPIOBDIR |= BIT(3); GPIOBPU300 &= ~BIT(3); GPIOBPU &= ~BIT(3);
    #define SD_DAT_RES_UP()         GPIOBPU300 = pu300; GPIOBPU = pu; GPIOBDIR = dir;
