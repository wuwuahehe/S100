...
#define UTX0MAP_PF0     (6 << 8)        //G6 uart0 tx: PF0
...
#define URX0MAP_PF1     (6 << 12)       //G6 uart0 rx: PF1
...
* Module    : SPDIF设备列表
*****************************************************************************/
#define SPF_PB0_CH0         0
#define SPF_PE5_CH1         1
#define SPF_PE6_CH2         2
#define SPF_PF0_CH3         3
#define SPF_PF1_CH4         4
#define SPF_PF2_CH5         5
...
#define DAC_DIFF_MIX    6              //DAC单通道差分输出
/*****************************************************************************
...
* Module    : FMTX声道选择
*****************************************************************************/
#define FMTX_MONO_L                 0   //FMTX输出音频L声道
#define FMTX_MONO_R                 1   //FMTX输出音频R声道
#define FMTX_MONO_M                 2   //FMTX输出 (L + R)/2
#define FMTX_STEREO                 3   //FMTX输出stereo
...
#define CH_AUXL_VCMBUF      0x05    //VCMBUF     -> left aux  -> sdadc left channel
#define CH_AUXL_MIC_PF2     0x06    //MIC(PF2)   -> left aux  -> sdadc left channel
#define CH_AUXL_MIC_PF3     0x07    //MIC(PF3)   -> left aux  -> sdadc left channel
#define CH_AUXL_VOUTRP      0x08    //VOUTRP     -> left aux  -> sdadc left channel
#define CH_MIC_PF2          0x0c    //MIC(PF2)   -> left mic  -> sdadc left channel
#define CH_MIC_PF3          0x0d    //MIC(PF3)   -> left mic  -> sdadc left channel
...
#define CH_AUXR_PF1         0x40    //AUXL3(PF1) -> right aux -> sdadc right channel
#define CH_AUXR_VCMBUF      0x50    //VCMBUF     -> right aux -> sdadc right channel
#define CH_AUXR_MIC_PF2     0x60    //MIC(PF2)   -> right aux -> sdadc right channel
#define CH_AUXR_MIC_PF3     0x70    //MIC(PF3)   -> right aux -> sdadc right channel
#define CH_AUXR_VOUTRP      0x80    //VOUTRN     -> right aux -> sdadc right channel
...
*****************************************************************************/
/* UART0 */
#define UART_RX0_G1_PA6        ((1 << 12)|(0 << 0))
#define UART_TX0_G1_PA7        ((1 <<  8)|(0 << 2))
#define UART_RX0_G2_PB1        ((2 << 12)|(1 << 0))
#define UART_TX0_G2_PB2        ((2 <<  8)|(1 << 2))
#define UART_RX0_G3_PB4        ((3 << 12)|(1 << 0))
#define UART_TX0_G3_PB3        ((3 <<  8)|(1 << 2))
#define UART_RX0_G4_PE6        ((4 << 12)|(2 << 0))
#define UART_TX0_G4_PE7        ((4 << 8) |(2 << 2))

/* UART1 */
#define UART_RX1_G1_PA6        ((1 << 28)|(0 << 0))
#define UART_TX1_G1_PA7        ((1 << 24)|(0 << 2))
#define UART_RX1_G2_PA3        ((2 << 28)|(0 << 0))
#define UART_TX1_G2_PA4        ((2 << 24)|(0 << 2))

/* UART2 */
#define UART_RX2_G2_PB1        ((2 <<  8)|(1 << 0))
#define UART_TX2_G2_PB2        ((2 <<  4)|(1 << 2))

#define UPDATE_UART0     0
#define UPDATE_UART1     1
#define UPDATE_UART2     2
...
* Module    : 蓝牙相关
*****************************************************************************/
#define HID_TYPE_PHOTO1      0        //自拍器(VOL+, 部分Android不能拍照)
#define HID_TYPE_PHOTO2      1        //自拍器(VOL+和ENTER, 影响IOS键盘使用)
#define HID_TYPE_GAMEPAD     2        //游戏手柄
#define HID_TYPE_KEYBOARD    3        //键盘
#define HID_TYPE_DOUYIN      4        //抖音
#define HID_TYPE_TSCREEN     5        //车机HID触摸

/*****************************************************************************
* Module    : 需要与 sysclk_sel_tbl 对应, 按时钟频率升序
*****************************************************************************/
#define SYS_2M              0
#define SYS_26M             1
#define SYS_48M             2
